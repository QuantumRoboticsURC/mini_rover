...
def imu_callback(data): 
    ...
    odom_pub = rospy.Publisher('combined_odom', PoseStamped, queue_size=10)
    ...
    odom_msg.pose.position.x = latitude            #  // x measurement GPS.
    odom_msg.pose.position.y = longitude           #  // y measurement GPS.
    odom_msg.pose.position.z = altitude            #  // z measurement GPS.
    odom_msg.pose.orientation.x = imu_x               #// identity quaternion
    odom_msg.pose.orientation.y = imu_y               #// identity quaternion
    odom_msg.pose.orientation.z = imu_z               #// identity quaternion
    odom_msg.pose.orientation.w = imu_w    
